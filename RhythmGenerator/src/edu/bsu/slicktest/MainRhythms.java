    ...
    public void update(GameContainer gc, int delta) throws SlickException
    {
    	...
    	if (input.isKeyPressed(Input.KEY_J))
    	{
    		...
    		if (selectorAngle >= 360)
    			selectorAngle -= 360;
    		try {rhythmFile.write("(" + Math.round(selectorAngle) + "," + selector.getRotations() + ",5)"); rhythmFile.newLine();} catch (IOException e) {}
    	}
    	...
    	if (input.isKeyPressed(Input.KEY_K))
    	{
    		...
    		if (selectorAngle >= 360)
    			selectorAngle -= 360;
    		try {rhythmFile.write("(" + Math.round(selectorAngle) + "," + selector.getRotations() + ",4)"); rhythmFile.newLine();} catch (IOException e) {}
    	}
    	...
    	if (input.isKeyPressed(Input.KEY_L))
    	{
    		...
    		if (selectorAngle >= 360)
    			selectorAngle -= 360;
    		try {rhythmFile.write("(" + Math.round(selectorAngle) + "," + selector.getRotations() + ",3)"); rhythmFile.newLine();} catch (IOException e) {}
    	}
    	
    	if (input.isKeyPressed(Input.KEY_SEMICOLON))
    	{
    		radar.keyPressed(';');
    		try {rhythmFile.write("(" + Math.round(selector.getAngle() + 180) + "," + selector.getRotations() + ",2)"); rhythmFile.newLine();} catch (IOException e) {}
    	}
    	
    	if (input.isKeyPressed(Input.KEY_SPACE))
    	{
    		radar.keyPressed(' ');
    		try {rhythmFile.write("(" + Math.round(selector.getAngle() + 180) + "," + selector.getRotations() + ",1)"); rhythmFile.newLine();} catch (IOException e) {}
    	}
